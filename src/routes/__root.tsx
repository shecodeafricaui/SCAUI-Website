...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "She Code Africa — UI Chapter" },
      {
        name: "description",
        content:
          "The University of Ibadan chapter of She Code Africa: learning tracks, events, projects and opportunities for women in tech.",
      },
      { property: "og:title", content: "She Code Africa — UI Chapter" },
      {
        property: "og:description",
        content: "Learn, build and grow with women in tech at the University of Ibadan.",
      },
